...
export default function About(){
  ...
  const stats = [
    ...
    {label: "Focus", value: "Scalability & performance"},
  ]
    ...
    className="min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
           <motion.div className="flex flex-col md:flex-row items-center md:items-stretch gap-8"
            ...
            rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-r from-[#1cd8d2]/20 to-[#302b63]/20 border-[#1cd8d2]/25
            "
            ...
            <div className="flex-1 flex flex-col justify-center text-center md:text-left">
              ...
              <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
                 I build scalable, modern applications with a strong focus on clean architecture , delightful UX, and performance. My toolkit spans C++, React, JavaScript, Tailwind CSS 
                 and Restful API-bringing ideas to life from concepts to production with robust APIs and smooth interfaces.
              </p>
              ...
              <div className="mt-6 flex flx-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
           ...
           >
            ...
            > I'm a third year BTech student, strong in JavaScript, React, backend fundamentals, consistently building projects and mastering the concepts.</p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg"> 
              Focused on growth, practices DSA in C++, learns system design, explores DevOps, and aims for impactful backend engineering roles.</p>
           </motion.div>
      </div>
